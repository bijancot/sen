...
<div class="row d-sm-flex align-items-center justify-content-between mb-4">
	<div class="col-lg-12">
		...
		<h5>Gunakan halaman ini untuk mengecek / Mereset Penilaian Juri</h5>
	</div>
</div>
<div class="row mb-4">
	<div class="col-md-3 mb-3">
		...
		<div class="col-md-9">
			...
			<div class="card shadow">
				...
				<div class="card-body">
					<table id="dataTable" class="table table-striped table-bordered1 table-sm table-hover">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama Tim</th>
								<th width="15%">Nama PTS</th>
								<th width="15%">Detail Kriteria</th>
													...
													<div class="col-md-9">
														...
														<div class="tab" data-id="tab<?php echo $juria->id;?>" id="<?php echo $juria->id;?>">
															<div class="row border-top">
																<div class="col-md-12 p-2 border-left border-right"><b>Detail Penilaian Juri</b> - <i><?php echo $juria->nama;?></i><a href="<?php

									echo site_url('Juri/ResetNilai/'.$id_tahap.'/'.$id_lomba.'/'.$juria->id_penilaian);?>" class="btn btn-sm btn-danger pull-right" role="button">Reset Nilai Juri Ini?</a></div>
															</div>
