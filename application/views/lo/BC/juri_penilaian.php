				...
				<table class="table">
					<?php $no=1;foreach ($daftar as $key) { ?>
						<tr class="<?=($this->uri->segment(3) == "$key->id" ? ' text-white bg-primary' : '');?>">
							...
							<td width="95%">
								<a href="<?php echo site_url('Juri/Penilaian/'.$key->id);?>" class="text-none">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="data">
									<?php if($peserta == false){echo "<b class='h5 font-weight-bold'><center>Pilih TIM</center></b>";}else{
										...
										if(end($file) == "pdf"){
											echo '<iframe src="'.base_url('').'berkas/'.$lomba->namalomba.'/'.$peserta->namatim.'('.$peserta->idpt.')/karya/'.$peserta->karya.'" style="height:450px;width:100%" title="Surat Pernyataan"></iframe>';
										}elseif(end($file) == "jpg" || end($file) == "png" || end($file) == "jpeg"){
											echo '<img src="'.base_url('').'berkas/'.$lomba->namalomba.'/'.$peserta->namatim.'('.$peserta->idpt.')/karya/'.$peserta->karya.'" class="img-fuild">';
											...
											if (isset($peserta->youtube)) {
												...
												echo '<iframe src="'.base_url('').'berkas/'.$lomba->namalomba.'/'.$peserta->namatim.'('.$peserta->idpt.')/karya/'.$peserta->karya.'" style="height:450px;width:100%"></iframe>';
											}
										}else{
												...
												<div class="modal-dialog modal-lg" role="document">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<hr class="mb-1">
															<label class="font-weight-bold">Tambahkan komentar</label>
