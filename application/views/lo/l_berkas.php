...
<div class="row d-sm-flex align-items-center justify-content-between mb-4">
	<div class="col-lg-9">
		<h1 class="h3 mb-0 text-gray-800"><b>BERKAS PESERTA</b> | Belum VERIFIKASI - <strong><?php if(!empty($namalomba->namalomba)){echo $namalomba->namalomba;}else{echo "Pilih Bidang Lomba";}?></strong></h1>
	</div>
				...
				<table class="table">
					<?php $no=1;foreach ($get_lomba as $key) { ?>
						<tr class="<?=($this->uri->segment(3) == "$key->id" ? ' text-white bg-primary' : '');?>">
							...
							<td width="95%">
								<a href="<?php echo site_url('Verifikasi/BerkasPeserta/'.$key->id);?>" class="text-none">
					...
					<table id="dataTable" class="table table-stripped table-sm table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#verfikasi<?php echo $no;?>">VERIF</button>
									<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#reject<?php echo $no;?>"><i class="fa fa-eraser"></i></button>
								</td>
								<td>
								    <?php 
								...
								<div id="anggota<?php echo $no;?>" class="modal fade" role="dialog" tabindex="-1" >
												...
												<div class="modal-body">
													...
													if (!empty($key->teaser)) {
														...
														if (strpos($key->teaser, "instagram")) {
															...
															echo '<p>Visit Page: <a href="'.$first[0].'" target="_blank">TIM - '.$key->namatim.'</a><p>';
														}else{
										...
										<div class="modal-dialog modal-lg" role="document">
											...
											<div class="modal-content">
												<div class="modal-header bg-success text-white">
													<h5 class="modal-title">Verifikasi - TIM <b><?php echo $key->namatim;?></b></h5>
													<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														<span aria-hidden="true">&times;</span>
													</button>
												</div>
												<!-- Modal body -->
												<div class="modal-body">
													Yakin verifikasi Tim <?php echo $key->namatim ?>?
													<p>Pastikan seluruh <b>BERKAS PESERTA</b> (<i>Data Anggota</i>, <i>KTM</i>, <i>Surat Pernyataan</i>, <i>Teaser</i>, dan <i>Karya Peserta</i>) telah <u>LENGKAP</u>.</p>
												</div>

												<!-- Modal footer -->
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
													<a href="<?php echo site_url('Verifikasi/VerifikasiPeserta/'.$key->id.'/'.$namalomba->id);?>" class="btn btn-success btn-sm">VERIFIKASI BERKAS</a>
												</div>
									...
									<!-- MODAL karya -->
									<div id="reject<?php echo $no;?>" class="modal fade" role="dialog" tabindex="-1" >
										<div class="modal-dialog modal-lg" role="document">
											<!-- Modal content-->
											<div class="modal-content">
												<div class="modal-header bg-danger text-white">
													<h5 class="modal-title">REJECT - TIM <b><?php echo $key->namatim;?></b></h5>
													<button type="button" class="close" data-dismiss="modal" aria-label="Close">
														<span aria-hidden="true">&times;</span>
													</button>
												</div>
												<!-- Modal body -->
												<div class="modal-body">
													Yakin MEREJECT Tim <?php echo $key->namatim ?>?
													<p>REJECT <b>BERKAS PESERTA</b> karena (<i>Data Anggota</i>, <i>KTM</i>, <i>Surat Pernyataan</i>, <i>Teaser</i>, dan <i>Karya Peserta</i>) BELUM <u>LENGKAP</u>.</p>
												</div>

												<!-- Modal footer -->
												<div class="modal-footer">
													<button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
													<a href="<?php echo site_url('Verifikasi/RejectPeserta/'.$key->id.'/'.$namalomba->id);?>" class="btn btn-danger btn-sm">REJECT BERKAS</a>
												</div>
