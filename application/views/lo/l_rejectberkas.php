...
<div class="row d-sm-flex align-items-center justify-content-between mb-4">
	<div class="col-lg-9">
		<h1 class="h3 mb-0 text-gray-800"><b>BERKAS PESERTA</b> | DiREJECT - <strong><?php if(!empty($namalomba->namalomba)){echo $namalomba->namalomba;}else{echo "Pilih Bidang Lomba";}?></strong></h1>
	</div>
				...
				<table class="table">
					<?php $no=1;foreach ($get_lomba as $key) { ?>
						<tr class="<?=($this->uri->segment(3) == "$key->id" ? ' text-white bg-primary' : '');?>">
							...
							<td width="95%">
								<a href="<?php echo site_url('Verifikasi/DataReject/'.$key->id);?>" class="text-none">
			...
			<div class="card border-left-primary shadow py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-sm font-weight-bold text-primary text-uppercase mb-1">TIM (Belum Verif)</div>
										...
										<div class="modal-dialog modal-lg" role="document">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a href="<?php echo site_url('Verifikasi/ResetPesertaR/'.$key->id.'/'.$namalomba->id);?>" class="btn btn-info btn-sm">RESET BERKAS</a>
												</div>
