...
<div class="alert alert-primary shadow alert-icon" role="alert">
	...
	Pilih tahap penilaian yang akan diset kriteria => pilih bidang lomba => kemudian tambah/ubah data kriteria penilaian
	<hr class="mt-1 mb-2">
	<p class="mb-0"><b>Catatan: Harap melengkapi kriteria di setiap bidang lomba, sebelum Tahap Penilaian Aktif</b></p>
</div>
<br>
<div class="row">
	<div class="col-xl-4">
