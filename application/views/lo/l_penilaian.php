...
<div class="row">
	...
	<div class="col-xl-4">
		<ul class="card shadow show-grid">
			...
			<?php }else{ $no = 1; foreach ($tahap_penilaian as $key) { if($key->aktif == 0){$aktif = "inactive"; $tahap = "<small class='badge badge-secondary d-inline'>Waiting...</small>";}elseif($key->aktif== 1){$aktif = "text-primary"; $tahap = "<small class='badge badge-primary d-inline'>BERLANGSUNG</small>";}else{$aktif = ""; $tahap = "<small class='badge badge-warning d-inline'>SELESAI</small>";}?>
			<li id="tahap1" class="col-md-12 border-bottom <?php echo $aktif;?>">
				<div class="media ml-2">
					<div class="pull-left" href="">
						<span class="glyphicon glyphicon-user"></span>
					</div>
			        <a href="<?php echo base_url();?>Penilaian/Tahap#<?php echo $no;?>" class="text-none <?php echo $aktif;?>">
					<div class="media-body">
