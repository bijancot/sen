						...
						<tbody>
							<?php $no = 1; foreach($peserta as $key){ ?>
								<tr>
									...
									<td class="text-center"><?php echo $key->nilai_akhir?></td>
									<td><a href="<?php
									
									$idnilai = $this->M_juri->get_id_nilai($key->id_peserta);
									
									echo site_url('Juri/ResetNilai/'.$id_tahap.'/'.$id_lomba.'/'.$idnilai->id_penilaian);?>" class="btn btn-sm btn-danger btn-block" role="button">Reset Nilai</a></td>
								</tr>
								<!-- MODAL Tambah -->
									...
									<div class="modal-dialog modal-lg" role="document">
										...
										<div class="modal-content">
											<div class="modal-header bg-info text-white">
												<h5 class="modal-title">Detail Nilai Penilaian</h5>
											...
											<div class="modal-body pr-5 pl-5">
												...
												<div class="row border-top bottom-2 border-bottom">
													<div class="col-md-12 p-2 border-left border-right"><b>Komentar:</b> <?php echo $key->note;?></div>
												</div>
												...
												$kriteria = $controller->M_juri->get_detail_nilai($key->id_penilaian);
												$nomor=1;
